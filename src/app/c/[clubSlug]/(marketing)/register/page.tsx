      ...
      <div className="relative hidden overflow-hidden felt-texture lg:block">
        ...
        <div className="relative flex h-full flex-col items-start justify-center px-16">
          ...
          <h2 className="mt-6 max-w-sm text-3xl font-bold text-foreground">
            Join the club. Compete for the title.
          </h2>
          <p className="mt-3 max-w-sm text-sm text-white/70">
            Create your account to register for tournaments and build your player profile.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center px-4 py-16 sm:px-6">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Set up your account, then complete your player profile.
          </p>

          <div className="mt-8">
            <RegisterForm redirectTo={redirectTo} clubSlug={clubSlug} />
          </div>

          <p className="mt-6 text-center text-sm text-muted-foreground">
            Already have an account?{" "}
            <Link
              href={`${clubPath(clubSlug, "/login")}?redirect=${encodeURIComponent(redirectTo)}`}
